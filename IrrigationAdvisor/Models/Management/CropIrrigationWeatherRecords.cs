...
namespace IrrigationAdvisor.Models.Management
{
    ...
    public class CropIrrigationWeatherRecords
    {
        ...
        public CropIrrigationWeatherRecords(int pId, CropIrrigationWeather pCropIrrigationWeather,
            ...
            double pTotalRealRain, double pTotalIrrigation, double pHidricBalance, double pSoilHidricVolume,
        ...
        public double  getPercentageOfAvailableWater()
        {
            ...
            double lAvailableWater = this.getSoilAvailableWaterCapacity();
            return Math.Round((lHidricBalance * 100) / lAvailableWater,2);
