...
namespace IrrigationAdvisor.Models.Management
{
    ...
    public class CropIrrigationWeatherRecords
    {
        ...
        private string printState()
        {
            ...
            string PercentAD = this.CropIrrigationWeather.getPercentageOfAvailableWater() + "        ";
            string AD = this.CropIrrigationWeather.getSoilAvailableWaterCapacity() + "        ";
            string CC = this.CropIrrigationWeather.getSoilFieldCapacity() + "        ";
            string PMP = this.CropIrrigationWeather.getSoilPermanentWiltingPoint() + "        ";
            ...
            ret = this.DayAfterSowing.First.ToString() +
                ...
                " \t\t " + this.CropIrrigationWeather.getRootDepth() +
            ...
            lMessage.Add(this.CropIrrigationWeather.getRootDepth().ToString());
        ...
        public double getEvapotranspirationCrop(DateTime pDate)
        {
            ...
            foreach (DailyRecord lDailyRec in this.DailyRecords)
            {
                if (lDailyRec.DateHour.Date.Equals(pDate.Date))
                {
                    lRetrun = lDailyRec.EvapotranspirationCrop.getTotalInput();
                    return lRetrun;
                }
            }
            return lRetrun;
