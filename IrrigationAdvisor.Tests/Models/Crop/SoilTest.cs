...
namespace IrrigationAdvisor.Tests.Models.Crop
{
    ...
    public class SoilTest
    {
        ...
        public void soilTestSantaLucia() 
        {
            ...
            double ad2 = lSoil.getAvailableWaterCapacity(35);
            ...
            lMessage += "getAvailableWaterCapacity(Root: 5): " + ad1 + Environment.NewLine;
            lMessage += "getAvailableWaterCapacity(Root: 35): " + ad2 + Environment.NewLine;
            lMessage += "getAvailableWaterCapacity(Root: 45): " + ad3 + Environment.NewLine;
            lMessage += "getAvailableWaterCapacity(Root: 57): " + ad4 + Environment.NewLine;
